...
namespace Job.Web.Controllers.Admin
{
    public class AdminAccountController : JobControllerBase
    {
        ...
        public ActionResult Login(string userNameOrEmailAddress = "", string returnUrl = "", string successMessage = "")
        {
            ...
            return View("~/Views/Admin/AdminAccount/Login.cshtml", new LoginFormViewModel
            {
                ReturnUrl = returnUrl,
        ...
        [HttpPost]
        [UnitOfWork]
        public virtual async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "admin/", string returnUrlHash = "")
        {
        ...
        private ActionResult RegisterView(RegisterViewModel model)
        {
            ...
            return View("~/Views/Admin/AdminAccount/Register.cshtml", model);
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                return View("~/Views/Admin/AdminAccount/RegisterResult.cshtml", new RegisterResultViewModel
                {
        ...
        {
            return Url.Action("Index", "AdminHome");
        }
        ...
        public async Task<ActionResult> TenantChangeModal()
        {
            ...
            return View("~/Views/Admin/AdminShared/Components/TenantChange/_ChangeModal.cshtml", new ChangeModalViewModel
            {
